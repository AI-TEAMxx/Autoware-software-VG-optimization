...
if("TRUE" STREQUAL "TRUE")
  set(vlg22c_cam_SOURCE_PREFIX /home/agilex/autoware.ai/src/drivers/awf_drivers/baumer)
  set(vlg22c_cam_DEVEL_PREFIX /home/agilex/autoware.ai/build/vlg22c_cam/devel)
  ...
  set(vlg22c_cam_INSTALL_PREFIX /home/agilex/autoware.ai/install/vlg22c_cam)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'vlg22c_cam' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/agilex/autoware.ai/src/drivers/awf_drivers/baumer/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/agilex/autoware.ai/build/vlg22c_cam/devel/lib;/home/agilex/autoware.ai/install/autoware_build_flags/lib;/opt/ros/melodic/lib)
